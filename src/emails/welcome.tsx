...
export default function WelcomeEmail({ name = "John" }: { name: string }) {
  return (
    <Html>
      <Head>
      ...
      <Body className="mx-auto max-w-[80ch] p-4">
        ...
        <Container className="max-w-[80ch] p-4">
          ...
          <Text className="text-foreground/50">
            Notification are off by default. You can enable them by signing in
            and heading over to your account settings. We recommend only
            enabling email notifications if you{"'"}d like to receive emails
          ...
          <Text className="text-foreground/50">
            You can enable email notifications by signing in and heading over to
            your account settings. We recommend only enabling email
            notifications if you{"'"}d like to receive emails about upcoming
            assignments.
          </Text>
        </Container>
      </Body>
