  ...
  return (
    <div className="relative" ref={tabsListRef}>
      <TabsPrimitive.List
        ...
        data-slot="tabs-list"
        className={cn(
          "bg-secondary/50 text-muted-foreground relative inline-flex h-9 w-fit items-center justify-center rounded-lg border p-[3px]",
          className,
        )}
        {...props}
      />
      <div
        className="bg-primary/50 dark:border-input absolute rounded-md border shadow-sm transition-all duration-300 ease-in-out"
