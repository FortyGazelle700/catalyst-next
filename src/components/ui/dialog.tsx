...
export const SetStateForOpenDialog = createContext<
...
function Dialog({
  ...
  return (
    <SetStateForOpenDialog.Provider value={setOpen}>
      <DialogPrimitive.Root data-slot="dialog" open={open} {...props} />
    </SetStateForOpenDialog.Provider>
  );
}
...
function DialogTrigger({
  ...
  const setOpen = useContext(SetStateForOpenDialog);
